...
# Procedure to solve dijkstra alghorithm.
...
# Initialize all distance vales as infinite at the beggining bcoz any distance would be less than than inf. Assign distance value as 0 for the source vertex so that it is picked first.

# 3) While shortest_path doesn’t include all vertices: 
